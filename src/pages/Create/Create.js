  ...
  return (
    <>
      <div className="outter-container">
        ...
        {/* <div className="tab-container">
          ...
          <div className="tab-title">
            <h5 className="bold-title">
              {window.location.path === "/employeeInfo"
                ? "თანამშრომლის ინფო"
                : "ლეპტოპის ინფო"}
            </h5>
            <p className="page">
              {window.location.path === "/employeeInfo" ? "1/2" : "2/2"}
            </p>
          </div>
          <div />
        </div> */}
        ...
        >
          <Tabs.TabPane tab="Tab 1" key="/employeeInfo">
            <div className="parent-container">
              <div className="main-container-container">
                <div className="main-employee-container">
                  <Form layout={"vertical"} form={employeeForm}>
          ...
          <Tabs.TabPane tab="Tab 2" key="/laptopSpecs">
            <div className="parent-container">
              <div className="main-container-container">
                <div className="main-employee-container">
                  <Form layout={"vertical"} form={laptopForm}>
